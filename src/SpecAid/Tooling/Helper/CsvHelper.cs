...
namespace SpecAid.Tooling.Helper
{
    public static class CsvHelper
    {
        ...
        private static string ConsumeNoQuoted(
            CsvSplitInfo info, char starter,
            StringEnumWithPeek readMe)
        {
            info.FieldExpected = false;
        ...
        private static string ComsumeQuoted(
            CsvSplitInfo info, StringEnumWithPeek readMe)
        {
            info.FieldExpected = false;
        ...
        private static void GoToNextItem(
            CsvSplitInfo info, StringEnumWithPeek readMe)
        {
            while (readMe.MoveNext())
            {
