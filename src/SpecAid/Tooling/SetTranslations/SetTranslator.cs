...
namespace SpecAid.Tooling.SetTranslations
{
    public class SetTranslator
    {
        ...
        /// </summary>
        public object Translate(PropertyInfo info, object target, object newItem)
        {
        ...
        private IEnumerable<ISetTranslation> _setActions;

        private IEnumerable<ISetTranslation> GetSetTranslations()
        {
            if (_setActions != null)
                return _setActions;
